...
$admin_contact = $row_admin['admin_phone'];
...
$update_admin = "update admin set admin_name='$admin_name',admin_email='$admin_email',admin_pass='$admin_pass',admin_image='$admin_image',admin_phone='$admin_contact' where admin_id='$admin_id'";
